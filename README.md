...
Latest status note, 2026-04-30: ADR-76 / G-6d.4 stopped before partition
freeze. Screening found two clean candidates for possible future freeze, but
the protocol now requires an exact +4 tranche split +3 train / +1 holdout; no
partial +2 corpus advance was made. The live corpus remains N=14.
